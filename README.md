...
엔진: Unity 6.0
언어: C#
툴체인: Input System, ParticleSystem, Rigidbody Physics, TextMeshPro, Git, VS Code
...
git clone https://github.com/<YOUR_ID>/RocketBoost.git


Unity Hub에서 프로젝트 열기 →
Assets/Scenes/Level01.unity 실행 → ▶️ Play

L키로 레벨 스킵, C키로 충돌 판정 On/Off 확인 가능.

<h2 id="controls">🎮 조작법 / Controls</h2>
동작	입력 키	설명
추진(Thrust)	Space	로켓 상향 추진
좌회전	A / ←	반시계 방향 회전
우회전	D / →	시계 방향 회전
충돌 토글	C	충돌 판정 on/off
레벨 스킵	L	다음 레벨로 이동
게임 종료	ESC	프로그램 종료
...
참고 강의: Complete C# Unity Game Developer 3D

<h2 id="contact">📬 연락처 / Contact</h2>

이메일: rladuan612@gmail.com

포트폴리오: https://www.naver.com
